  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <a class="logo-wrapper waves-effect">
        ...
        <img src="img/imagesss.jpg" width="150px" height="200px;" class="img-fluid" alt="">
      </a>
...
<tbody>
    ...
    <tr>
      ...
      <td><?php echo $download; ?></td>
           ...
           <td><a href='downloads.php?file_id=<?php echo $id; ?>'  class="btn btn-sm btn-outline-primary" style="border-color: #DDFF75;"><i class="fa fa-download"></i></a> <a href='delete.php?ID=<?php echo $id; ?>'  class="btn btn-sm btn-outline-danger"><i class="fa fa-trash"></i></a>
    </tr>
<?php } ?>
</tbody>
   </table>
    ...
    <div class="footer-copyright py-3">
     <p>All right Reserved &copy; <?php echo date('Y');?> Created By:Tan Nguyen</p>
    </div>
    <!--/.Copyright-->
