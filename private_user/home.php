...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:arial,helvetica,sans-serif,verdana,'Open Sans'">
  ...
  <!--Navbar -->
  <nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top" style="background-color: bisque;">
    <a class="navbar-brand" href="#"><img src="js/img/Files_Downloads.png" width="33px" height="33px">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <font color="black">Xin chào!,</font> <?php echo ucwords(htmlentities($id)); ?> <i class="fas fa-user-circle"></i> Login
          </a>
      ...
      <div class="col-md-9">
        ...
        <table id="dtable" class="table table-striped" style="">
          <thead>
            ...
            <th style="color: rgb(255, 51, 218)">Filename</th>
            <th style="color: rgb(255, 51, 218)">FileSize</th>
            <th style="color: rgb(255, 51, 218)">Uploader</th>
            <th style="color: rgb(255, 51, 218)">Status</th>
            <th style="color: rgb(255, 51, 218)">Date/Time</th>
            <th style="color: rgb(255, 51, 218)">Downloads</th>
            <th style="color: rgb(255, 51, 218)">Action</th>
      ...
      <div class="col-md-3" style="border-top: 4px solid #17a2b8;border-radius: 4px;  box-shadow: 0px 1px 1px 0px  #6c757d;"><br>
        ...
        <div class="tab-content pt-2 pl-1" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
            <img src="img/nel.jpg" class="rounded" alt="..." style="width: 50%;">
            <hr>
            <div class="">

              <div class="">
                <p><b style="font-size: 1.1em;" >Full Name:</b> <b style="font-weight: bold;">Nguyen Van Tan.</b></p>
              </div>
              <div class="">
                <p><b style="font-size: 1.1em">Position:</b><b style="font-weight: bold;">Software Engineer</b></p>
              </div>
          ...
          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <h6 style="font-size: 1.1em">File Management System<b style="font-weight: bold;"> (FMS)</b></h6>
            <Hr>
            is a system (based on computer programs in the case of digital document management) used to track, manage, and store documents of most MIS subjects including textbooks, slides, exam questions,... There are many different versions of Ho Chi Minh City Banking University's subjects created and modified by other users. each other (historical tracking).          </div>
          <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            <h6 style="font-size: 1.1em">Contact Number</h6>
            <Hr><br>
            <div class="">
              <p><b style="font-size: 1.1em">Cellphone:</b>0799465582</p>
            </div>
            <p><b style="font-size: 1.1em">Address :</b>Thuc Duc, HCM</p>
          </div>
          <hr><br>
          <!--   <div class="card">
    ...
    <li class="list-group-item">Vestibulum at eros</li>
          ...
          <div class="card" style="border-top: 4px solid #17a2b8;border-radius: 4px;">
            ...
            <div class="card-body">
              ...
              <ul>
                <li>
                  <p>Ensuring documents are always updated promptly</p>
                </li>
                <li>
                  <p>Ensuring that searches are as quick and convenient as possible</p>
                </li>
                <li>
                  <p>Preventing “unintended” use of outdated documents</p>
                </li>
              </ul>
              <!-- Button -->
